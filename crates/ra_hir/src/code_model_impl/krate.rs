...
impl Crate {
    pub(crate) fn dependencies_impl(&self, db: &dyn PersistentHirDatabase) -> Vec<CrateDependency> {
    ...
    pub(crate) fn root_module_impl(&self, db: &dyn PersistentHirDatabase) -> Option<Module> {
